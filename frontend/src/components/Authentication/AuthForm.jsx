...
export default function AuthForm({
  ...
  const handleAccountLocked = useCallback(() => {
    setConfirmationModal({
      ...
      message:
        "Your account has been temporarily locked due to multiple failed login attempts. Would you like to reset your password?",
      type: "warning",
  ...
  React.useEffect(() => {
    if (!isSignUp && loginAttempts === 3) {
      showWarning(
        "Warning: 2 more failed attempts will lock your account",
        5000
      );
