  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={`absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-purple-500 to-transparent transition-opacity duration-700 ${
        ...
        {/* Glow effect */}
        <div
          className={`absolute inset-0 bg-gradient-to-r from-purple-600/5 via-pink-600/5 to-purple-600/5 transition-opacity duration-700 ${
            isScrolled ? "opacity-100" : "opacity-0"
          }`}
        />
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
          <div className="flex justify-between items-center h-20">
            ...
            {/* Enhanced Desktop Menu - Updated with Reviews */}
        ...
        {/* Enhanced Mobile Menu - Updated with Reviews */}
        <div
