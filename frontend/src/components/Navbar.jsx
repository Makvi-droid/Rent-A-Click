            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-64 pl-10 pr-4 py-2 bg-gray-900/50 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-300 group-hover:border-purple-400"
                  onKeyPress={(e) => {
                    if (e.key === 'Enter') {
