  ...
  return (
    <div className="space-y-8">
        ...
        <div className="space-y-3">
          <label className="flex items-center p-4 bg-gray-800/30 border border-gray-600 rounded-xl cursor-pointer hover:border-purple-500/50 transition-all duration-300">
            ...
            <div className="flex items-center flex-1">
              ...
              <div>
                <span className="text-white font-medium">Store Pickup</span>
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  {subtotal >= 5000 ? (
                    ...
                    `10% of order total - ${formatCurrency(subtotal * 0.1)}`
                  )}
                </p>
              </div>
            </div>
      ...
      <div className="space-y-6">
        ...
        >
          {/* Pickup Time - Only show for pickup method */}
          ...
          {/* Return Time - Always show but with different labels */}
          <div>
            <label className="block text-sm font-medium text-gray-300 mb-2">
              {formData.deliveryMethod === "delivery"
            ...
            {formData.deliveryMethod === "delivery" && (
              <p className="text-gray-400 text-sm mt-2">
                This is when you'll bring the items back to our store
              </p>
            )}
          </div>
        </div>
      ...
      {rentalDays > 0 && (
        <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 border border-purple-500/30 rounded-xl p-4">
          <div className="flex items-center space-x-2">
            ...
            {formData.deliveryMethod === "delivery" && formData.returnTime && (
              <span className="text-gray-300 text-sm">
                (Return by {formatTime(formData.returnTime)})
              </span>
            )}
          </div>
        </div>
